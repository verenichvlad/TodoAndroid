package com.example.veren.todolist;
...
import com.example.veren.todolist.db.Task;
import com.example.veren.todolist.db.TaskHelper;
...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        DialogInterface.OnClickListener addTaskHandler = new DialogInterface.OnClickListener() {
            @Override
        ...
        AlertDialog dialog = new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Add", addTaskHandler)
